...
use super::ui_resourses::{FontHolder, MenuTitles};
...
fn set_up_font_resource(mut commands: Commands, assets: Res<AssetServer>) {
    ...
    commands.insert_resource(MenuTitles::new());
}

fn setup_ui_menu(mut commands: Commands, font_holder: Res<FontHolder>, titles: Res<MenuTitles>) {
